...
var AuthController = function () {
    var _classDecorators = [(0, swagger_1.ApiTags)('auth'), (0, common_1.Controller)('api/auth')];
        ...
        AuthController_1.prototype.login = function (dto) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.authService.login(dto.username, dto.password)];
                });
            });
        };
        AuthController_1.prototype.getSession = function () {
            return __awaiter(this, void 0, void 0, function () {
                var session;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.authService.getCurrentSession()];
                        case 1:
                            session = _a.sent();
                            if (!session) {
    ...
    (function () {
        ...
        _login_decorators = [(0, common_1.Post)('login'), (0, swagger_1.ApiOperation)({ summary: 'Login to Instagram' })];
        _getSession_decorators = [(0, common_1.Get)('session'), (0, swagger_1.ApiOperation)({ summary: 'Get current session' })];
